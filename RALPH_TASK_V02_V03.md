...
Expected output (as of iter-21; rerun any time on `HEAD`):

```
✓ Commits since baseline (f9c4406)
  41 commits on feat/v0.2-overnight since f9c4406
✓ Backend tests (docker-run maven, no host JDK)
  mvn test green — Tests run: 286, Failures: 0, Errors: 0, Skipped: 0
