...
These 5 landscape photos are shown as the hero on the onboarding wizard's
welcome and done screens. All are Wikimedia Commons files, downloaded once
and bundled with the SPA — no runtime dependency on any external service.
